...
<head>
  ...
  <title>
    Components Documentation - Argon Design System by Creative Tim
  </title>
  <!--     Fonts and icons     -->
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="navbar_global">
        ...
        <span class="navbar-nav navbar-nav-hover align-items-lg-center">
            <h5 style="color: #fff;">{{ env("APP_NAME") }}</h5>
  ...
  <div class="page-header clear-filter">
    ...
    <div class="content-center text-center">
      <div class="col-md-8 ml-auto mr-auto">
        ...
        <img styleOLD="height: 60px;" src="{{ asset('/') }}img/nadma_logo.png">
          ...
          <br />
          <a href="https://demos.creative-tim.com/argon-design-system/docs/getting-started/overview.html" class="btn btn-primary btn-round btn-lg">View documentation</a>
        </div>
      </div>
    </div>
  </div>
