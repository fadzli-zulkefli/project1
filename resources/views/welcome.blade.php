        ...
        <div class="col-md-6">
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form onsubmit="return onsubmit_form()" action="{{ url('/semakan') }}" method="GET" role="form">
                @csrf
          ...
          <br>
            <strong><b b style="color:red">Bantuan Khas Kehilangan Pendapatan RM100 sehari kerana dikuarantin/dirawat.</b></strong>
            <br />
            <br>
            <strong>FAQ - Garis Panduan Pemberian Bantuan Khas COVID-19</strong>
            <a href="http://www.nadma.gov.my/ms/bantuan-khas/bantuan-khas-covid-19">http://www.nadma.gov.my/ms/bantuan/bantuan-khas-covid-19</a>
            <br />
            <br>
            ...
            <a href="http://www.nadma.gov.my/ms/bantuan-khas/bantuan-khas-pengurusan-kematian-covid-19">http://www.nadma.gov.my/ms/bantuan/bantuan-khas-pengurusan-kematian-covid-19</a>
